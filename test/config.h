...
# To create a shortwave gas-optics model including the far-UV
# extension (116-200 nm), we use files in parallel directories
# replacing "sw" with "swuv", but the files within them are labelled
# with "sw" in order that the scripts don't need to be changed.
SW_TAG=sw
#SW_TAG=swuv
...
# Original file interpolated from NRL2 dataset
#SSI_FILE=ckdmip_ssi.h5
# Updated file interpolated from newer TSIS1 dataset
SSI_FILE=ckdmip_ssi_tsis1.h5
...
MMM_SW_SPECTRA_DIR=${MMM_DIR}/${SW_TAG}_spectra
MMM_SW_SPECTRA_EXTRA_DIR=${MMM_DIR}/${SW_TAG}_spectra_extras
MMM_SW_SSI=${MMM_SW_SPECTRA_EXTRA_DIR}/$SSI_FILE
...
IDEALIZED_SW_SPECTRA_DIR=${IDEALIZED_DIR}/${SW_TAG}_spectra
...
TRAINING_SW_SPECTRA_DIR=${TRAINING_DIR}/${SW_TAG}_spectra
TRAINING_SW_FLUXES_DIR=${TRAINING_DIR}/${SW_TAG}_fluxes
...
#TRAINING_SW_SSI=${TRAINING_SW_SPECTRA_DIR}/$SSI_FILE
#TRAINING_SW_SSI=${CKDMIP_DATA_DIR}/evaluation1/${SW_TAG}_spectra/$SSI_FILE
# The solar spectral irradiance is independent of dataset so we can use the MMM one
TRAINING_SW_SSI=$MMM_SW_SSI
...
EVALUATION_SW_SPECTRA_DIR=${EVALUATION_DIR}/${SW_TAG}_spectra
EVALUATION_SW_FLUXES_DIR=${EVALUATION_DIR}/${SW_TAG}_fluxes
...
WORK_SW_SPECTRA_DIR=${WORK_DIR}/${SW_TAG}_spectra
WORK_SW_ORDER_DIR=${WORK_DIR}/${SW_TAG}_order
WORK_SW_GPOINTS_DIR=${WORK_DIR}/${SW_TAG}_gpoints
WORK_SW_RAW_CKD_DIR=${WORK_DIR}/${SW_TAG}_raw-ckd-definition
WORK_SW_CKD_DIR=${WORK_DIR}/${SW_TAG}_ckd-definition
WORK_SW_CKD_OD_DIR=${WORK_DIR}/${SW_TAG}_optical-depth
WORK_SW_LBL_FLUX_DIR=${WORK_DIR}/${SW_TAG}_lbl_fluxes
WORK_SW_FLUX_DIR=${WORK_DIR}/${SW_TAG}_fluxes
...
# Shortwave bands with a UV extension to 86000 cm-1
WN1_SWUV_WINDOW="$WN1_SW_WINDOW 50000"
WN2_SWUV_WINDOW="$WN2_SW_WINDOW 86000"

#WN1_SWUV_PHOTOLYSIS="13250 14300 16650 20000 25000 28550 30250 30750 31250 31750 32250 32750 33250 33750 44000 48000"
#WN2_SWUV_PHOTOLYSIS="14300 16650 20000 25000 28550 30250 30750 31250 31750 32250 32750 33250 33750 44000 48000 86000"
# Improved treatment of Hartley band for ClOO photolysis: extend it from 44000 to 45000
#WN1_SWUV_PHOTOLYSIS="13250 14300 16650 20000 25000 28550 30250 30750 31250 31750 32250 32750 33250 33750 45000 48000"
#WN2_SWUV_PHOTOLYSIS="14300 16650 20000 25000 28550 30250 30750 31250 31750 32250 32750 33250 33750 45000 48000 86000"
# ...and separate band for far UV from start of Schumann-Runge continuum to Lyman alpha line
WN1_SWUV_PHOTOLYSIS="13250 14300 16650 20000 25000 28550 30250 30750 31250 31750 32250 32750 33250 33750 45000 48000 57200"
WN2_SWUV_PHOTOLYSIS="14300 16650 20000 25000 28550 30250 30750 31250 31750 32250 32750 33250 33750 45000 48000 57200 86000"
