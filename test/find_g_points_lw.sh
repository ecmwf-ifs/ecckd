...
\begin h2o
  ...
  reordering_input lw_order_h2o.h5
  # Other gases in present-day concentrations, except ozone which uses
  # the minimum concentration
  background_input "ckdmip_mmm_lw_spectra_merge-well-mixed_minimum.h5
            ckdmip_mmm_lw_spectra_o3_minimum.h5"
\end h2o

\begin o3
  input ckdmip_mmm_lw_spectra_o3_median.h5
  reordering_input lw_order_o3.h5
  background_input "ckdmip_mmm_lw_spectra_merge-well-mixed_minimum.h5
            ckdmip_mmm_lw_spectra_h2o_minimum.h5"
\end o3

\begin composite
  input ckdmip_mmm_lw_spectra_merge-well-mixed_present.h5
  reordering_input lw_order_merge-well-mixed.h5
...
\begin composite
  ...
  reordering_input lw_order_composite.h5
  background_input "ckdmip_mmm_lw_spectra_h2o_minimum.h5
            ckdmip_mmm_lw_spectra_o3_minimum.h5"
\end composite
...
do
	...
	${FIND_G_POINTS_LW} \
	    ...
	    config_find_g_points_lw_${APP}.cfg $EXTRA_ARGS \
