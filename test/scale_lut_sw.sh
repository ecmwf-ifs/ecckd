#!/bin/bash
# Scale the coefficients in a shortwave CKD look-up table in order to
# give the exact direct flux for a single reference atmosphere
# (usually the median atmosphere of the MMM dataset).
...
do
	...
	GPOINTFILE=${WORK_SW_GPOINTS_DIR}/sw_gpoints_${MODEL_CODE}.h5
