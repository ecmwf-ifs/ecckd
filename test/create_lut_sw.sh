...
ckdmip_idealized_sw_spectra_cfc11_constant-equivalent.h5
ckdmip_idealized_sw_spectra_cfc12_constant.h5
...
\begin cfc11
  conc_dependence linear
  input ckdmip_idealized_sw_spectra_cfc11_constant-equivalent.h5
\end cfc11

\begin cfc12
  conc_dependence linear
  input ckdmip_idealized_sw_spectra_cfc12_constant.h5
\end cfc12
...
then
    cat > config_create_lut_climate4.cfg <<EOF
# THIS FILE WAS AUTOMATICALLY GENERATED BY $0
...
do
	...
	INPUT=sw_gpoints_${MODEL_CODE}.h5
	...
	$CREATE_LOOK_UP_TABLE \
	    ...
	    | tee ${WORK_SW_RAW_CKD_DIR}/sw_raw-ckd_${MODEL_CODE}.log
    done
done
